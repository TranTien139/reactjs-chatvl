...
import {getArticleCate} from '../actions/articleActions';
...
class Category extends Component {
    ...
    componentDidMount(){
        ...
        let category = this.props.params.slug;
        ...
        this.props.getArticleCate(category,queryParams-1);
    }

    render(){
        const imageList = this.props.cates.cates;
